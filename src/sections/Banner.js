    ...
    <div className="banner pb-10">
      ...
      <div className="container grid sm:grid-cols-12 items-center">
        <div className="mt-20 sm:mt-28 md:mt-40  sm:col-span-8  lg:col-span-7 ">
          <h1
            className="font-sans font-bold text-2xl  sm:text-3xl  md:text-5xl w-6/12 sm:w-auto"
            data-aos={"fade-up"}
          >
          ...
          <p
            data-aos={"fade-up"}
            className="font-serif font-normal mt-4 w-6/12 sm:w-auto md:max-w-lg  text-sm max-w-xs sm:pr-10 md:mr-0 md:text-base"
          >
          ...
          <div className="font-serif mt-10 sm:mt-14">
            ...
            <div
              data-aos={"fade-up"}
              className="grid grid-flow-col gap-6 justify-start mt-8 sm:mt-10"
            >
